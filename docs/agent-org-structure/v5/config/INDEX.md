...
- `rule-pack.v1.role.experience` v3 adds claim-conflict, product-experience evidence, and Engineering-handoff dry-run coverage.
...
| `rule-pack.v1.role.experience` | [`rule-packs/rule-pack.v1.role.experience.md`](./rule-packs/rule-pack.v1.role.experience.md) | v3 experience/brand rules with claim-conflict, product-experience evidence, and Engineering-handoff dry-run coverage. |
...
Quality gate definitions for the GitHub v3 write and merge checks, including configured-state, provider-effective, and product-experience evidence boundaries, live in [`verification-hooks.v1.md`](./verification-hooks.v1.md) v1.3.
