...
- Slock description (identity signature): short role/scope signature. Illustrative examples: `PM · project-a`, `TL · project-a + project-b`, `QA · cross-team`, `UX · cross-team`. Not the canonical role contract; agents may later edit it to reflect current focus.
